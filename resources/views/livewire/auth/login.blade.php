<main class="flex flex-col gap-8 mx-auto p-10">
    ...
    <form wire:submit.prevent="login" class="flex flex-col gap-4 bg-neutral-800 p-5 border border-neutral-600 ">
        <div class="flex flex-col gap-2 text-left">
            <label class="text-neutral-400 text-sm font-semibold">Username:</label>
            <input class="bg-neutral-700 border-neutral-600 text-neutral-300" type="text" wire:model="username"/>
